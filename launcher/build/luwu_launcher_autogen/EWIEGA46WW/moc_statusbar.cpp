...
static constexpr auto qt_meta_stringdata_ZN9StatusBarE = QtMocHelpers::stringData(
    "StatusBar",
    "updateStatus",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9StatusBarE[] = {
...
Q_CONSTINIT const QMetaObject StatusBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9StatusBarE.offsetsAndSizes,
    qt_meta_data_ZN9StatusBarE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9StatusBarE_t,
        // Q_OBJECT / Q_GADGET
...
void *StatusBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9StatusBarE.stringdata0))
